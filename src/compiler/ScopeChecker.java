    ...
    public void notExistError(List<List> list, String scope) {
        switch (scope) {
            ...
            case "var":
                ...
                if (!findMeInMyParent(list.get(0) + "")) {
                    error_number++;
            ...
            case "method":
                if (!findMeInMyParent(list.get(0) + "")) {
                    error_number++;
                    System.out.println("Error" + error_number + " : " + "in line [" + list.get(1) + ":" + list.get(2) + "], cannot find method [" + list.get(0) + "]");
                }
